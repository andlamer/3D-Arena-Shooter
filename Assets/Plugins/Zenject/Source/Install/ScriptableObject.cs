...
namespace Zenject
{
    ...
    public class ScriptableObject : ScriptableObjectInstallerBase
    {
    }
    ...
    //
    public class ScriptableObject<TDerived> : ScriptableObject
        where TDerived : ScriptableObject<TDerived>
    {
