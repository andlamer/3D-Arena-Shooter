...
namespace Zenject
{
    ...
    {
        [SerializeField]
        List<ScriptableObject> _scriptableObjectInstallers = new List<ScriptableObject>();
        ...
        public IEnumerable<ScriptableObject> ScriptableObjectInstallers
        {
...
//#endif
        ...
        protected void InstallInstallers(
            ...
            List<ScriptableObject> scriptableObjectInstallers,
