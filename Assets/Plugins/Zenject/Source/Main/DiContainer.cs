...
namespace Zenject
{
    ...
    public class DiContainer : IInstantiator
    {
...
#if !NOT_UNITY3D
            if (concreteType.DerivesFrom<UnityEngine.ScriptableObject>())
            {
                ...
                {
                    newObj = UnityEngine.ScriptableObject.CreateInstance(concreteType);
                }
                else
                {
        ...
        {
            Assert.DerivesFromOrEqual<UnityEngine.ScriptableObject>(scriptableObjectType);
            ...
            Type scriptableObjectType, string resourcePath, List<TypeValuePair> extraArgs)
        {
            ...
            var newObj = UnityEngine.ScriptableObject.Instantiate(objects.Single());
